...
def main(filename, road_number, check):
    ...
    for n in range(road_number):
        ...
        metal_counter, ceramic_counter = int(requirement_array[n][1]), int(requirement_array[n][2])
        ...
        if (check == True):
            ...
            print("")
            print("You will need", requirement_array[n][0], "chiral crystals for this autopaver.", "\n") 
            pause()
